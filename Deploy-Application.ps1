...
Try {
	...
	[string]$appName = 'FolderSizes'
	[string]$appVersion = '9.5.409'
	[string]$appArch = 'x64'
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.0.0'
	[string]$appScriptDate = '2022.08.12'
	...
	# Application uninstall parameters.
	$64bitAppUninstallParam = "/x {F2491C14-6D32-4731-8FA8-EE4CC6840EC5} /qn"
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		Remove-Item -Path "${Env:PUBLIC}\Desktop\FolderSizes 9.lnk"
		Remove-Item -Path "${Env:PUBLIC}\Desktop\FolderSizes 9 (Run as Admin).lnk"
